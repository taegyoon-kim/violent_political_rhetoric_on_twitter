...
os.chdir('/Users/taegyoon/Google Drive/diss_detection')

# Authentification (Taegyoon's developer account: threat_dectector_py)
auth = OAuthHandler('', '')
...
while True:
    ...
    def Streaming(tags = None, follow = None, lang = None):
        try:
            ...
            streamer.filter(track=['Trump'], encoding = 'utf8', languages = ['en'])
